...
<head>
    ...
    <!--bootstrap-touchspin-->
    <link href="{{asset("css/bootstrap-touchspin.css")}}" rel="stylesheet">
        <!--Data Table-->
    ...
    <link href="{{asset("js/data-table/css/dataTables.scroller.css")}}" rel="stylesheet"><!--data table init-->
        ...
        <div class="sidebar-left">
            ...
            <div class="logo dark-logo-bg visible-xs-* visible-sm-*">
                <a href="index.html">
                    ...
                    <span class="brand-name">Demo US</span>
                </a>
            </div>
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list"><a href=""><i class="fa fa-book"></i> <span>DRG Budget</span></a>
                        <ul class="child-list">
                            <li><a href="{{url('drgs')}}"> DRG</a></li>
                            <li><a href="{{url('drg-services')}}"> Drg Services</a></li>
...
<!--tags input init-->
<script src="{{asset("js/tags-input-init.js")}}"></script>
...
<!--spinner init-->
<script src="{{asset("js/spinner-init.js")}}"></script>
